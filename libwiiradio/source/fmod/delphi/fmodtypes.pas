...
type
  FMOD_CREATESOUNDEXINFO = record
    ...
    initialseekpostype: Integer;                       (* [in] Optional. Specify 0 to ignore. For streams. Specify the time unit for the position set in initialseekposition. *)
  end;
